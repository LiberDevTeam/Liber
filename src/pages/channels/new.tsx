...
export const NewChannel: React.FC = () => {
  ...
  return (
    <div className="my-4 mx-2">
      <h1 className="mt-8 mb-8 text-3xl font-semibold leading-6 text-gray-800">
        New Channel
      </h1>
      <div className="col-span-6 sm:col-span-4 mb-4">
        ...
        <input
          ...
          type="text"
          id="name"
          className="rounded p-2 shadow focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm border-gray-300 border"
        />
      </div>
